...
def run_experiment():
    ...
    # Dataset generation / synthetic speech byte stream
    ...
    # Train data: Synthetic structured byte sequences with high-entropy dependencies
    ...
    for label, active_vecs in variants:
        ...
        # Unfreeze epigenetic gates to simulate evolutionary growth
        for name, param in model.named_parameters():
            if 'alpha_epi' in name or 'unit_alphas' in name:
                param.data.fill_(0.5) # Warm-up epigenetic activation
