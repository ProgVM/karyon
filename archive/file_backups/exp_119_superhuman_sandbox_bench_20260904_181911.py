...
def run_experiment():
    ...
    for inp_b, tgt_b in encoded_batches:
        ...
        w_curr = agent_sandbox.in_proj(agent_sandbox.pos_embeddings(inp_b[:, -1:], start_pos=0, apply_rf=True)).squeeze(1)
        ...
        # 1-Shot Episodic Memory Write of the optimal thought candidate
        with torch.no_grad():
            mem_sandbox.write(best_thought_h, w_curr)
