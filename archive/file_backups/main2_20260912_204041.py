...
<body>
    <div id="karyon-container">
        ...
        <div id="config-drawer" class="config-drawer">
            <div class="cfg-grid">
                ...
                <div class="cfg-item">
                    ...
                    <input type="text" id="cfg-models-pool" class="cfg-input" value="gemini-3.8-flash, gemini-3.7-flash, gemini-3.6-flash, gemini-3.5-flash, gemini-2.5-flash, gemini-2.5-flash-lite, gemini-2.0-flash">
                </div>
                <div class="cfg-item">
                    <label>Summarizer Models Pool:</label>
                    <input type="text" id="cfg-sum-pool" class="cfg-input" value="gemini-3.8-flash, gemini-3.7-flash, gemini-3.6-flash, gemini-3.5-flash, gemini-2.5-flash, gemini-2.5-flash-lite">
                </div>
                <div class="cfg-item">
        ...
        <div style="padding: 10px 12px; background: #11111b; border-top: 1px solid #313244;">
...
async def async_main():
    ...
    async def on_send_message_py(user_text: str):
