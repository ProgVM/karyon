...
===============================================================================
Hypothesis:
Coupling online stream adaptation (brief 10-step spatial sensory & world model grounding)
with System 2 Parallel Mental Sandbox (parallel_rollout_search) in CS-World will:
  ...
  2. Demonstrate significant survival advantage for System 2 counterfactual look-ahead over System 1.
  3. Reduce cumulative Free Energy (FE) and avoid hazard impacts.
===============================================================================
"""
...
def quick_spatial_grounding_adaptation(agent, device='cpu', steps=20):
    """
    Brief online stream adaptation (20 steps) to align Motor Gateway and World Model
    ...
    for step in range(steps):
        ...
        # Derive optimal action signal
        ax, ay = world_temp.agent_pos
        # Determine safest direction away from hazards
