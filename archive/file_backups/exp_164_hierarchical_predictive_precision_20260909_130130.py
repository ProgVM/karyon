...
def main():
    ...
    # Baseline: Legacy unmodulated router
    ...
    b_init_loss, b_final_loss, b_init_fe, b_final_fe, b_delta = run_benchmark_cycle(
        brain, entity, legacy_router, num_steps=12
    )
    ...
    # Proposed: Dynamic Allostatic Precision Router
    ...
    p_init_loss, p_final_loss, p_init_fe, p_final_fe, p_delta = run_benchmark_cycle(
        brain, entity, proposed_router, num_steps=12
    )
    ...
    events = entity.interact("Hello! How do you perceive the world?", max_tokens=25)
