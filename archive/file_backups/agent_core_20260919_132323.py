...
class KaggleCoREAgent:
    ...
    async def process_user_query(
        ...
        if hasattr(self, "bus") and self.bus:
            self.bus.set_ui_notifier(event_callback)
        if hasattr(self, 'multi_agent_manager') and self.multi_agent_manager:
            ...
            if hasattr(self.multi_agent_manager, "bus") and self.multi_agent_manager.bus:
                self.multi_agent_manager.bus.set_ui_notifier(event_callback)
