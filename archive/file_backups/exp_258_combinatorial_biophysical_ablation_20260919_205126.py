...
class CombinatorialBiophysicalAgent(nn.Module):
    def __init__(self, vocab_size=258, dim=256, use_a=False, use_b=False, use_c=False, device="cuda"):
        ...
        # Stage 1: Fast Fast/Morphological SSD
        self.ssd_fast = karyon_core.CausalParallelSSD(dim, device, 0.05, 0.5)
        ...
        # Stage 2: Contextual/Slow SSD
        self.ssd_slow = karyon_core.CausalParallelSSD(dim, device, 0.0005, 0.02)
