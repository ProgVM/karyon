...
def main():
    ...
    # 2. Proposed Evaluation (256D entropy_predictor, dynamic allostatic dt scaling)
    ...
    with torch.no_grad():
        proposed_entropy_net[0].weight[:64, :].copy_(brain_p.entropy_predictor[0].weight)
        proposed_entropy_net[0].bias[:64].copy_(brain_p.entropy_predictor[0].bias)
        proposed_entropy_net[2].weight[:, :64].copy_(brain_p.entropy_predictor[2].weight)
        proposed_entropy_net[2].bias.copy_(brain_p.entropy_predictor[2].bias)
