...
def run_experiment():
    ...
    with torch.no_grad():
        loss_before, fe_before = agent.forward_sequence(x, target_seq, hu_st, criterion_speech)[:2]
    ...
    with torch.no_grad():
        loss_after, fe_after = agent.forward_sequence(x, target_seq, hu_st, criterion_speech)[:2]
