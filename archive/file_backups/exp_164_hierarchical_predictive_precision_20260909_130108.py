...
def train_stream_steps(brain, entity, num_steps=10):
    """
...
def main():
    ...
    base_loss, base_fe, base_delta = train_stream_steps(brain, entity, num_steps=10)
    ...
    prop_loss, prop_fe, prop_delta = train_stream_steps(brain, entity, num_steps=10)
