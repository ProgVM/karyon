...
> **Standard:** KEP v8.0 Master (Mandatory for all human architects and AI collaborators).
...
3. **Hardware Efficiency:** Peak VRAM/HBM consumption and token throughput ($\text{tok/s} \ge 80\%$ baseline).
