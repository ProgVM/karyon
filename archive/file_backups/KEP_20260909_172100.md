...
14. **Principle 14 (The Ashby-Friston Vitality Standard):** The ultimate measure of Karyon-CoRE's architectural perfection and cognitive completeness is the **Ashby-Friston Vitality Test (AFVT) / Тест Кариона**. All future features, layers, and learning algorithms must be designed, evaluated, and optimized to drive the system toward a validated pass of the 7 pillars of non-machine biophysical vitality ($\mathcal{V}_{\text{AFVT}} \ge 0.85$).
...
1. **Context-Specific Target Metrics:**
   ...
   * **Non-Machine Vitality Index:** The Ashby-Friston Vitality Index ($\mathcal{V}_{\text{AFVT}}$) across the 7 core pillars.
