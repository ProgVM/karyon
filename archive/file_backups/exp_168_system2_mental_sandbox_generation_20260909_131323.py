...
def main():
    ...
    for p in prompts:
        text, _ = custom_generate_thought_and_speech(brain, p, entity.hu, entity.episodic_memory, None, max_generated_tokens=40, enable_sandbox=False)
    ...
    t0 = time.perf_counter()
    for p in prompts:
        text, calls = custom_generate_thought_and_speech(brain, p, entity.hu, entity.episodic_memory, None, max_generated_tokens=40, enable_sandbox=True)
        ttr = compute_ttr(text)
