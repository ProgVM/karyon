...
class Net2NetMorphogenesisEngine:
    ...
    def expand_agent_dimensions(
        ...
        with torch.no_grad():
            ...
            if hasattr(agent, 'topdown_prior_proj'):
                agent.topdown_prior_proj = Net2NetMorphogenesisEngine.expand_linear_layer(
                    agent.topdown_prior_proj, new_hidden_dim, new_hidden_dim, device=device
                )

            # 4. Will Engine expansion
            ...
            # 5. Volitional Prediction Head expansion
            ...
            # 6. Hopfield Attractor Head expansion
