...
class ParallelMorphicCrucible:
    ...
    def __init__(
        ...
        # Attention / Gaze projection: [P, dim, 1]
    ...
    def evaluate_and_select(
        ...
        prompts = [list(p.encode('utf-8')) for p, _ in stream_batch]
        targets = [list(t.encode('utf-8')) + [10] for _, t in stream_batch]
