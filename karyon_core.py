...
print("[C++ JIT] Compiling and linking native Karyon architecture (v13 PyBind Fixed)...")

karyon_cpp = load(
    name="karyon_cpp_ext_v13",
...
print("[C++ JIT] Native C++ v13 Master architecture successfully initialized!")
