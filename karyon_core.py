...
print("[C++ JIT] Compiling and linking native Karyon architecture (v17 Hierarchical Master)...")

karyon_cpp = load(
    name="karyon_cpp_ext_v17",
...
print("[C++ JIT] Native C++ v17 Hierarchical Master successfully initialized!")
