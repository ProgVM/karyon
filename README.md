...
5. **Afferent-Efferent Lexical Weight Tying:** Directly couples the motor readout projection with transposed byte embeddings ($W\_{\text{emb}}^T / \sqrt{D\_{\text{text}}}$), ensuring non-vanishing gradient highways ($\|\nabla W\_{\text{emb}}\| > 0.04$).
