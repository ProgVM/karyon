...
def run_experiment():
    print("=" * 80)
    print("EXP-260: VECTORIZED CIRCUIT BUILDER & OPERATOR-CIRCUIT SYNERGY (AD) BENCHMARK")
    print("=" * 80)
    ...
    variants = [
        ...
        ("Vector D (Batched Vectorized Circuit Builder)", ['D']),
        ("Vector AD Synergy (Micro-Operator + Vectorized Circuit)", ['AD'])
    ]
    ...
    print("\n" + "=" * 80)
    print("EXP-260 SUMMARY & TELEMETRY TABLE (REAL-WORLD ALPACA)")
    print("=" * 80)
    ...
    with open("experiments/exp_260_results.json", "w") as f:
