...
def run_production_epigenetic_verification():
    ...
    print(f"    • Post-Sleep Topology: {manifest_post_sleep['k_nodes']} nodes.")
    ...
    assert forgetting_delta <= 0.45, f"ERROR: Forgetting Delta {forgetting_delta:.4f} exceeds safety threshold!"
